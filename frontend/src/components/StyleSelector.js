  ...
  return (
    <FormControl className={classes.formControl}>
      <InputLabel htmlFor="age-native-helper">
        Select a style transformer model
      </InputLabel>
      <Select
        value={props.modelID}
        onChange={(event) => {
      ...
      >
        <MenuItem value={0}>Rain Princess</MenuItem>
        <MenuItem value={1}>Candy</MenuItem>
        <MenuItem value={2}>Mosaic</MenuItem>
        <MenuItem value={3}>Udnie</MenuItem>
      </Select>
    </FormControl>
  );
}